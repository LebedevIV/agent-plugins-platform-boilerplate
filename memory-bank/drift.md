...
- declared only: memory-bank/INDEX.md
- declared only: memory-bank/architecture/README.md
- declared only: memory-bank/audit_logs.md
...
- declared only: packages/i18n/package.json