...
## 🛡️ Основные принципы разработки (ОБЯЗАТЕЛЬНЫЕ)

### 1. Принцип "Не навреди" (Do No Harm)
- **Безопасность прежде всего**: Любые изменения должны улучшать безопасность системы, а не ослаблять её
...
- **Тестирование**: Все изменения должны проходить тщательное тестирование перед внедрением
- **Мониторинг**: Отслеживать влияние изменений на производительность и стабильность

### 2. Принцип "Комментарии для ИИ" (AI-First Documentation)
- **Аналитические комментарии**: Добавлять комментарии, объясняющие логику и архитектурные решения для понимания ИИ
- **Контекстные пояснения**: Объяснять "почему", а не только "что" делает код
- **Архитектурные комментарии**: Документировать связи между компонентами и потоки данных
...
- **Архитектурные паттерны**: Использовать проверенные архитектурные паттерны и принципы
- **Стандарты кодирования**: Следовать принятым стандартам и конвенциям
- **Безопасность**: Применять принципы безопасности (Zero Trust, Defense in Depth, Least Privilege)
- **Производительность**: Оптимизировать критичные пути и избегать антипаттернов
- **Масштабируемость**: Проектировать с учётом будущего роста и изменений
